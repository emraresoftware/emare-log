...
<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Tarife Düzenle</li>
        </ol>
    </nav>

    <h1 class="h3 mb-4">Tarife Düzenle: {{ $tarife->ad }}</h1>

    <form method="POST" action="{{ route('tarife.update', $tarife->id) }}">
        @csrf
        @method('PUT')
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="ad" class="form-control @error('ad') is-invalid @enderror" value="{{ old('ad', $tarife->ad) }}" required>
                        @error('ad')
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="kod" class="form-control @error('kod') is-invalid @enderror" value="{{ old('kod', $tarife->kod) }}" required>
                        @error('kod')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4">
                        ...
                        <input type="text" name="aciklama" class="form-control" value="{{ old('aciklama', $tarife->aciklama) }}">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" name="download_hizi" class="form-control @error('download_hizi') is-invalid @enderror" value="{{ old('download_hizi', $tarife->download_hizi) }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" name="upload_hizi" class="form-control @error('upload_hizi') is-invalid @enderror" value="{{ old('upload_hizi', $tarife->upload_hizi) }}" required>
                            <span class="input-group-text">Mbps</span>
                        </div>
                        @error('upload_hizi')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" name="kota" class="form-control" value="{{ old('kota', $tarife->kota) }}" min="0">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" name="fiyat" id="fiyat" class="form-control @error('fiyat') is-invalid @enderror" value="{{ old('fiyat', $tarife->fiyat) }}" required>
                        </div>
                        @error('fiyat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" step="0.01" name="kdv_orani" id="kdvOrani" class="form-control @error('kdv_orani') is-invalid @enderror" value="{{ old('kdv_orani', $tarife->kdv_orani) }}" required>
                            <span class="input-group-text">%</span>
                        </div>
                        @error('kdv_orani')
                            <div class="invalid-feedback">{{ $message }}</div>
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" name="taahhut_suresi" class="form-control" value="{{ old('taahhut_suresi', $tarife->taahhut_suresi) }}" min="0">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">₺</span>
                            <input type="number" step="0.01" name="kurulum_ucreti" class="form-control" value="{{ old('kurulum_ucreti', $tarife->kurulum_ucreti) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Durum <span class="text-danger">*</span></label>
                        <select name="durum" class="form-select" required>
                            <option value="aktif" {{ old('durum', $tarife->durum) == 'aktif' ? 'selected' : '' }}>Aktif</option>
                            <option value="pasif" {{ old('durum', $tarife->durum) == 'pasif' ? 'selected' : '' }}>Pasif</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-end gap-2 mb-4">
            ...
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-save me-1"></i> Tarife Güncelle
            </button>
        </div>
