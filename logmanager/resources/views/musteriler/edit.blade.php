...
<div class="page-header d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="page-title">Müşteri Düzenle - {{ $musteri->ad }} {{ $musteri->soyad }}</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('musteriler.show', $musteri->id) }}">{{ $musteri->abone_no }}</a></li>
                <li class="breadcrumb-item active">Düzenle</li>
            </ol>
        </nav>
    </div>
    <a href="{{ route('musteriler.show', $musteri->id) }}" class="btn btn-outline-secondary">
...
<form action="{{ route('musteriler.update', $musteri->id) }}" method="POST" id="musteriForm">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-12">
                    ...
                    <div class="d-flex gap-4">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="musteri_tipi" id="tipBireysel" value="bireysel" {{ old('musteri_tipi', $musteri->musteri_tipi) === 'bireysel' ? 'checked' : '' }}>
                            <label class="form-check-label" for="tipBireysel">Bireysel</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="musteri_tipi" id="tipKurumsal" value="kurumsal" {{ old('musteri_tipi', $musteri->musteri_tipi) === 'kurumsal' ? 'checked' : '' }}>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('tc_kimlik_no') is-invalid @enderror" id="tc_kimlik_no" name="tc_kimlik_no" value="{{ old('tc_kimlik_no', $musteri->tc_kimlik_no) }}" maxlength="11" placeholder="11 haneli TC Kimlik No">
                    @error('tc_kimlik_no') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4">
                    <label for="ad" class="form-label">Ad</label>
                    <input type="text" class="form-control @error('ad') is-invalid @enderror" id="ad" name="ad" value="{{ old('ad', $musteri->ad) }}" required>
                    @error('ad') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4">
                    <label for="soyad" class="form-label">Soyad</label>
                    <input type="text" class="form-control @error('soyad') is-invalid @enderror" id="soyad" name="soyad" value="{{ old('soyad', $musteri->soyad) }}" required>
                    @error('soyad') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                {{-- Kurumsal Alanlar --}}
                <div class="col-md-4 kurumsal-alan" style="{{ old('musteri_tipi', $musteri->musteri_tipi) === 'kurumsal' ? '' : 'display:none;' }}">
                    <label for="vergi_dairesi" class="form-label">Vergi Dairesi</label>
                    <input type="text" class="form-control @error('vergi_dairesi') is-invalid @enderror" id="vergi_dairesi" name="vergi_dairesi" value="{{ old('vergi_dairesi', $musteri->vergi_dairesi) }}">
                    @error('vergi_dairesi') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4 kurumsal-alan" style="{{ old('musteri_tipi', $musteri->musteri_tipi) === 'kurumsal' ? '' : 'display:none;' }}">
                    <label for="vergi_no" class="form-label">Vergi No</label>
                    <input type="text" class="form-control @error('vergi_no') is-invalid @enderror" id="vergi_no" name="vergi_no" value="{{ old('vergi_no', $musteri->vergi_no) }}">
                    @error('vergi_no') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4 kurumsal-alan" style="{{ old('musteri_tipi', $musteri->musteri_tipi) === 'kurumsal' ? '' : 'display:none;' }}">
                    <label for="firma_unvani" class="form-label">Firma Ünvanı</label>
                    <input type="text" class="form-control @error('firma_unvani') is-invalid @enderror" id="firma_unvani" name="firma_unvani" value="{{ old('firma_unvani', $musteri->firma_unvani) }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" class="form-control @error('dogum_tarihi') is-invalid @enderror" id="dogum_tarihi" name="dogum_tarihi" value="{{ old('dogum_tarihi', $musteri->dogum_tarihi) }}">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select @error('cinsiyet') is-invalid @enderror" id="cinsiyet" name="cinsiyet">
                        ...
                        <option value="erkek" {{ old('cinsiyet', $musteri->cinsiyet) === 'erkek' ? 'selected' : '' }}>Erkek</option>
                        <option value="kadin" {{ old('cinsiyet', $musteri->cinsiyet) === 'kadin' ? 'selected' : '' }}>Kadın</option>
                    </select>
                    @error('cinsiyet') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-3">
                    <label for="telefon" class="form-label">Telefon</label>
                    <input type="tel" class="form-control @error('telefon') is-invalid @enderror" id="telefon" name="telefon" value="{{ old('telefon', $musteri->telefon) }}" placeholder="05XX XXX XX XX" required>
                    @error('telefon') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-3">
                    <label for="eposta" class="form-label">E-Posta</label>
                    <input type="email" class="form-control @error('eposta') is-invalid @enderror" id="eposta" name="eposta" value="{{ old('eposta', $musteri->eposta) }}">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select @error('uyruk') is-invalid @enderror" id="uyruk" name="uyruk">
                        <option value="tc" {{ old('uyruk', $musteri->uyruk) === 'tc' ? 'selected' : '' }}>T.C.</option>
                        <option value="yabanci" {{ old('uyruk', $musteri->uyruk) === 'yabanci' ? 'selected' : '' }}>Yabancı</option>
                    </select>
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <select class="form-select select2 @error('il') is-invalid @enderror" id="il" name="il" required>
                        ...
                        @if(isset($iller))
                            @foreach($iller as $il)
                                <option value="{{ $il->id }}" {{ old('il', $musteri->il) == $il->id ? 'selected' : '' }}>{{ $il->ad }}</option>
                            @endforeach
                        @endif
                    </select>
                    ...
                    <select class="form-select select2 @error('ilce') is-invalid @enderror" id="ilce" name="ilce" required>
                        ...
                        @if(isset($ilceler))
                            @foreach($ilceler as $ilce)
                                <option value="{{ $ilce->id }}" {{ old('ilce', $musteri->ilce) == $ilce->id ? 'selected' : '' }}>{{ $ilce->ad }}</option>
                            @endforeach
                        @endif
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('mahalle') is-invalid @enderror" id="mahalle" name="mahalle" value="{{ old('mahalle', $musteri->mahalle) }}">
                    @error('mahalle') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4">
                    <label for="cadde_sokak" class="form-label">Cadde / Sokak</label>
                    <input type="text" class="form-control @error('cadde_sokak') is-invalid @enderror" id="cadde_sokak" name="cadde_sokak" value="{{ old('cadde_sokak', $musteri->cadde_sokak) }}">
                    @error('cadde_sokak') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-2">
                    <label for="bina_no" class="form-label">Bina No</label>
                    <input type="text" class="form-control @error('bina_no') is-invalid @enderror" id="bina_no" name="bina_no" value="{{ old('bina_no', $musteri->bina_no) }}">
                    @error('bina_no') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-2">
                    <label for="daire_no" class="form-label">Daire No</label>
                    <input type="text" class="form-control @error('daire_no') is-invalid @enderror" id="daire_no" name="daire_no" value="{{ old('daire_no', $musteri->daire_no) }}">
                    @error('daire_no') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-2">
                    <label for="posta_kodu" class="form-label">Posta Kodu</label>
                    <input type="text" class="form-control @error('posta_kodu') is-invalid @enderror" id="posta_kodu" name="posta_kodu" value="{{ old('posta_kodu', $musteri->posta_kodu) }}">
                ...
                <div class="col-md-12">
                    ...
                    <textarea class="form-control @error('adres_aciklama') is-invalid @enderror" id="adres_aciklama" name="adres_aciklama" rows="2">{{ old('adres_aciklama', $musteri->adres_aciklama) }}</textarea>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <select class="form-select select2 @error('tarife_id') is-invalid @enderror" id="tarife_id" name="tarife_id" required>
                        ...
                        @foreach($tarifeler as $tarife)
                            <option value="{{ $tarife->id }}" {{ old('tarife_id', $musteri->tarife_id) == $tarife->id ? 'selected' : '' }}>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select select2 @error('kampanya_id') is-invalid @enderror" id="kampanya_id" name="kampanya_id">
                        ...
                        @foreach($kampanyalar ?? [] as $kampanya)
                            <option value="{{ $kampanya->id }}" {{ old('kampanya_id', $musteri->kampanya_id) == $kampanya->id ? 'selected' : '' }}>{{ $kampanya->ad }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select select2 @error('bolge_id') is-invalid @enderror" id="bolge_id" name="bolge_id">
                        ...
                        @foreach($bolgeler as $bolge)
                            <option value="{{ $bolge->id }}" {{ old('bolge_id', $musteri->bolge_id) == $bolge->id ? 'selected' : '' }}>{{ $bolge->ad }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" class="form-control @error('hizmet_baslangic_tarihi') is-invalid @enderror" id="hizmet_baslangic_tarihi" name="hizmet_baslangic_tarihi" value="{{ old('hizmet_baslangic_tarihi', $musteri->hizmet_baslangic_tarihi) }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" class="form-control @error('sozlesme_suresi') is-invalid @enderror" id="sozlesme_suresi" name="sozlesme_suresi" value="{{ old('sozlesme_suresi', $musteri->sozlesme_suresi) }}" min="1">
                ...
                <div class="col-md-3">
                    ...
                    <div class="d-flex gap-3 mt-1">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="taahhut" id="taahhutVar" value="1" {{ old('taahhut', $musteri->taahhut) == '1' ? 'checked' : '' }}>
                            <label class="form-check-label" for="taahhutVar">Var</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="taahhut" id="taahhutYok" value="0" {{ old('taahhut', $musteri->taahhut) == '0' ? 'checked' : '' }}>
                            <label class="form-check-label" for="taahhutYok">Yok</label>
                        </div>
                    </div>
                    @error('taahhut') <div class="text-danger small">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-3" id="taahhutBitisAlani" style="{{ old('taahhut', $musteri->taahhut) == '1' ? '' : 'display:none;' }}">
                    <label for="taahhut_bitis_tarihi" class="form-label">Taahhüt Bitiş Tarihi</label>
                    <input type="date" class="form-control @error('taahhut_bitis_tarihi') is-invalid @enderror" id="taahhut_bitis_tarihi" name="taahhut_bitis_tarihi" value="{{ old('taahhut_bitis_tarihi', $musteri->taahhut_bitis_tarihi) }}">
                    @error('taahhut_bitis_tarihi') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-3">
                    <div class="form-check mt-4">
                        <input class="form-check-input" type="checkbox" name="sanal_magaza_musterisi" id="sanal_magaza_musterisi" value="1" {{ old('sanal_magaza_musterisi', $musteri->sanal_magaza_musterisi) ? 'checked' : '' }}>
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <select class="form-select select2 @error('mikrotik_id') is-invalid @enderror" id="mikrotik_id" name="mikrotik_id">
                        ...
                        @foreach($mikrotikler as $mikrotik)
                            <option value="{{ $mikrotik->id }}" {{ old('mikrotik_id', $musteri->mikrotik_id) == $mikrotik->id ? 'selected' : '' }}>{{ $mikrotik->ad }}</option>
                        @endforeach
                    </select>
                    ...
                    <select class="form-select select2 @error('hat_id') is-invalid @enderror" id="hat_id" name="hat_id">
                        ...
                        @if(isset($hatlar))
                            @foreach($hatlar as $hat)
                                <option value="{{ $hat->id }}" {{ old('hat_id', $musteri->hat_id) == $hat->id ? 'selected' : '' }}>{{ $hat->ad }}</option>
                            @endforeach
                        @endif
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select select2 @error('ip_adresi') is-invalid @enderror" id="ip_adresi" name="ip_adresi">
                        ...
                        @if($musteri->ip_adresi)
                            <option value="{{ $musteri->ip_adresi }}" selected>{{ $musteri->ip_adresi }} (Mevcut)</option>
                        @endif
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('mac_adresi') is-invalid @enderror" id="mac_adresi" name="mac_adresi" value="{{ old('mac_adresi', $musteri->mac_adresi) }}" placeholder="XX:XX:XX:XX:XX:XX">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('pppoe_kullanici') is-invalid @enderror" id="pppoe_kullanici" name="pppoe_kullanici" value="{{ old('pppoe_kullanici', $musteri->pppoe_kullanici) }}">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control @error('pppoe_sifre') is-invalid @enderror" id="pppoe_sifre" name="pppoe_sifre" value="{{ old('pppoe_sifre', $musteri->pppoe_sifre) }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" class="form-control @error('download_hizi') is-invalid @enderror" id="download_hizi" name="download_hizi" value="{{ old('download_hizi', $musteri->download_hizi) }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" class="form-control @error('upload_hizi') is-invalid @enderror" id="upload_hizi" name="upload_hizi" value="{{ old('upload_hizi', $musteri->upload_hizi) }}">
                    @error('upload_hizi') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-2">
                    <label for="vlan_id" class="form-label">VLAN ID</label>
                    <input type="number" class="form-control @error('vlan_id') is-invalid @enderror" id="vlan_id" name="vlan_id" value="{{ old('vlan_id', $musteri->vlan_id) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('modem_marka_model') is-invalid @enderror" id="modem_marka_model" name="modem_marka_model" value="{{ old('modem_marka_model', $musteri->modem_marka_model) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('modem_sn') is-invalid @enderror" id="modem_sn" name="modem_sn" value="{{ old('modem_sn', $musteri->modem_sn) }}">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <select class="form-select @error('odeme_yontemi') is-invalid @enderror" id="odeme_yontemi" name="odeme_yontemi">
                        <option value="">Seçiniz</option>
                        <option value="nakit" {{ old('odeme_yontemi', $musteri->odeme_yontemi) === 'nakit' ? 'selected' : '' }}>Nakit</option>
                        <option value="havale" {{ old('odeme_yontemi', $musteri->odeme_yontemi) === 'havale' ? 'selected' : '' }}>Havale / EFT</option>
                        <option value="kredi_karti" {{ old('odeme_yontemi', $musteri->odeme_yontemi) === 'kredi_karti' ? 'selected' : '' }}>Kredi Kartı</option>
                        <option value="otomatik_cekim" {{ old('odeme_yontemi', $musteri->odeme_yontemi) === 'otomatik_cekim' ? 'selected' : '' }}>Otomatik Çekim</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select @error('fatura_tipi') is-invalid @enderror" id="fatura_tipi" name="fatura_tipi">
                        <option value="">Seçiniz</option>
                        <option value="e-fatura" {{ old('fatura_tipi', $musteri->fatura_tipi) === 'e-fatura' ? 'selected' : '' }}>E-Fatura</option>
                        <option value="e-arsiv" {{ old('fatura_tipi', $musteri->fatura_tipi) === 'e-arsiv' ? 'selected' : '' }}>E-Arşiv</option>
                        <option value="matbu" {{ old('fatura_tipi', $musteri->fatura_tipi) === 'matbu' ? 'selected' : '' }}>Matbu</option>
                    </select>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control @error('not') is-invalid @enderror" id="not" name="not" rows="3" placeholder="Müşteri ile ilgili notlarınız...">{{ old('not', $musteri->not) }}</textarea>
    ...
    <div class="d-flex justify-content-end mb-4">
        <button type="submit" class="btn btn-primary btn-lg">
            <i class="fas fa-save me-1"></i> Müşteri Güncelle
        </button>
    </div>
</form>
@endsection
...
<script>
    $(document).ready(function() {
        ...
        $('#mikrotik_id').on('change', function() {
            ...
            let currentHatId = '{{ $musteri->hat_id }}';
            ...
            if (mikrotikId) {
                $.get('/api/mikrotikler/' + mikrotikId + '/hatlar', function(data) {
                    ...
                    data.forEach(function(hat) {
                        let selected = hat.id == currentHatId ? ' selected' : '';
                        options += '<option value="' + hat.id + '"' + selected + '>' + hat.ad + '</option>';
                    });
                    $('#hat_id').html(options);
                });
            } else {
